...
const Spots = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-106px)] bg-gray-100">
      ...
      {/* Desktop floating open button when list is collapsed */}
      {!isListExpanded && (
        <button
          onClick={toggleList}
          className="hidden md:flex fixed top-24 left-4 z-40 bg-white p-3 rounded-full shadow-lg"
      ...
      <div 
        className={`${isListExpanded ? 'translate-x-0 md:translate-x-0 md:w-96 lg:w-1/3 xl:w-1/4' : '-translate-x-full md:translate-x-0 md:w-0 md:overflow-hidden'} 
                   fixed md:relative inset-y-0 left-0 z-40 w-full bg-white overflow-y-auto transition-all duration-300 ease-in-out`}
      >
        <div className="p-6">
