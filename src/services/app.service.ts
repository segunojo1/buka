...
class AppService {
    ...
    public async getBusynessQuick({latitude, longitude}: {latitude: number, longitude: number}) {
        try {
            const response = await this.api.post(`/api/Busyness/quick`, {latitude, longitude})
            return response.data;
        } catch (error) {
    ...
    public async getSpotBusyness({placeId, spotId}: {placeId?: string, spotId: string}) {
        try {
    ...
    public async recordUserCheckIn({userId, spotId}: {userId: string, spotId: string}) {
        try {
            const response = await this.api.post(`/api/Busyness/check-in`, {userId, spotId});
            return response.data;
        } catch (error) {
    ...
    public async getAlternativesSpots(spotId: string) {
        try {
            const response = await this.api.get(`/api/Busyness/${spotId}/alternatives`)
            return response.data;
        } catch (error) {
    ...
    public async getBatchBusyness({places, includeHeatmap=true}: {places: string[], includeHeatmap?: boolean}) {
        try {
